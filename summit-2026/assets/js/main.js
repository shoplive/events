...
"<b>오주영</b> KEB하나은행 데이터마케팅팀 라이브커머스 총괄": "<b>Juyoung Oh</b> Head of Live Commerce, Data Marketing Team, KEB Hana Bank",
"어려운 금융, 라이브로 어떻게 고객과 소통하는가?<small>오주영 총괄 / KEB하나은행</small>": "Finance feels hard — how does a bank talk with its customers through live?<small>Juyoung Oh, Head of Live Commerce / KEB Hana Bank</small>",
"오주영 총괄 / KEB하나은행": "Juyoung Oh, Head of Live Commerce / KEB Hana Bank",
...
"일본 최대 뷰티 플랫폼이 라이브커머스를 어떻게 바라보고 있는지, 현지 기업의 시각으로 직접 전합니다. 샵라이브 AI STT 기술을 통해서 한국어 통역이 실시간 제공됩니다.": "Japan's largest beauty platform on how it sees live commerce — first-hand, from a company on the ground. Korean interpretation is delivered in real time by Shoplive's AI STT.",
...
"<b>오주영</b> KEB하나은행 데이터마케팅팀 라이브커머스 총괄": "<b>オ・ジュヨン</b> データマーケティングチーム ライブコマース総括、KEBハナ銀行",
"어려운 금융, 라이브로 어떻게 고객과 소통하는가?<small>오주영 총괄 / KEB하나은행</small>": "難しい金融、ライブで顧客とどうコミュニケーションするか？<small>オ・ジュヨン 総括 / KEBハナ銀行</small>",
"오주영 총괄 / KEB하나은행": "オ・ジュヨン 総括 / KEBハナ銀行",
...
"일본 최대 뷰티 플랫폼이 라이브커머스를 어떻게 바라보고 있는지, 현지 기업의 시각으로 직접 전합니다. 샵라이브 AI STT 기술을 통해서 한국어 통역이 실시간 제공됩니다.": "日本最大のビューティプラットフォームがライブコマースをどう捉えているのか、現地企業の視点でお伝えします。ShopliveのAI STT技術により、韓国語通訳をリアルタイムでご提供します。",
