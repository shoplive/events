...
window.I18N = {
en: {
"라이브 기술이 만드는 <span>확장과 기회</span>": "Live technology that opens <span>growth and opportunity</span>",
...
"성과를 만들고 있는 플랫폼과 브랜드의 <b>실행법</b>": "The <b>playbook</b> of platforms and brands already delivering results",
"카테고리별 <b>라이브·숏폼 성공 전략</b>": "Category-by-category <b>live &amp; short-form strategy</b>",
"한국에서 일본까지, <b>확장과 성장의 기회</b>": "From Korea to Japan, <b>the next chance to grow</b>",
...
"각자의 시장에서 실제 성과로 증명해온 성공 사례와 인사이트를 공유하고, 이를 바탕으로 한국의 라이브커머스 역량이 아시아 시장으로 확장되는 새로운 교두보를 함께 만들어가고자 합니다.": "Each speaker shares the cases and insights they have proven with real results in their own market, and together we aim to build a new bridgehead that carries Korea's live commerce capability into the wider Asian market.",
...
"10:30 – 11:00<span class=\"sub\">등록 후 바로 프로그램이 시작됩니다</span>": "10:30 – 11:00<span class=\"sub\">The programme begins as soon as check-in closes</span>",
...
"글로벌로 넓혀갈 새로운 관계와 기회를 찾고 싶다면": "Find the relationships and openings that take you global",
"망설임을 확신으로 바꾸기": "Turn hesitation into a decision",
"등록 · 체크인<small>11:00까지 등록을 마치고 바로 시작합니다</small>": "Registration &amp; check-in<small>Check-in closes at 11:00 and the programme begins</small>",
...
"등록 후 바로 프로그램이 시작됩니다": "The programme begins as soon as check-in closes",
...
"11:00까지 등록을 마치고 바로 시작합니다": "Check-in closes at 11:00 and the programme begins",
...
"확장과 성장의 기회": "the next chance to grow",
"김기영": "Kiyoung Kim",
"이규원": "Kyuwon Lee",
"김성진": "Sungjin Kim",
...
"라이브커머스를 이끄는 리더들이<br /><em>한 자리에</em>": "ライブコマースを牽引するリーダーが<br /><em>一堂に</em>",
...
"리빙 라이브의 진화, 구경을 넘어 구매로": "リビングライブの進化 — 眺めるから買うへ",
...
"한국에서 일본까지, <b>확장과 성장의 기회</b>": "韓国から日本へ、<b>拡張と成長の機会</b>",
...
"각자의 시장에서 실제 성과로 증명해온 성공 사례와 인사이트를 공유하고, 이를 바탕으로 한국의 라이브커머스 역량이 아시아 시장으로 확장되는 새로운 교두보를 함께 만들어가고자 합니다.": "それぞれの市場で実際の成果によって証明されてきた事例とインサイトを共有し、韓国のライブコマースの力がアジア市場へ広がる新たな足がかりを、ともにつくっていきます。",
"단순히 성공 사례를 ‘듣는’ 자리가 아닙니다.<br />2026년 하반기와 2027년, 무엇을 실행하고 어떻게 성장할 것인지를 함께 고민하고, 새로운 비즈니스 기회와 전략을 구체화하는 자리입니다.": "成功事例をただ「聞く」ための場ではありません。<br />2026年下半期と2027年に何を実行し、どう成長させるのかをともに考え、新しいビジネスの機会と戦略を形にする場です。",
...
"아이에게 쓰는 물건일수록 선택이 신중해집니다. 그 신뢰를 라이브로 어떻게 쌓았는지 공유합니다.": "子どもに使うものほど、選び方は慎重になります。その信頼をライブでどう積み上げてきたのかを共有します。",
...
"지금 가장 앞서가는 브랜드들의 이야기를 한자리에서 듣고,<br />그 기회를 우리의 비즈니스로 만들고 돌아가는 자리입니다.": "いま最も先を行くブランドの話を一度に聞き、<br />その機会を自社のビジネスに変えて持ち帰る場です。",
...
"참가비는 따로 없습니다. 초청드린 분들을 정성껏 모시고 싶어 준비한 자리라, 편안하게 참석해 주시면 됩니다.": "参加費はいただきません。ご招待した皆さまをお迎えするために用意した場ですので、どうぞお気軽にお越しください。",
...
"리빙 라이브의 진화, 구경을 넘어 구매로<small>오늘의집</small>": "リビングライブの進化 — 眺めるから買うへ<small>Ohouse</small>",
