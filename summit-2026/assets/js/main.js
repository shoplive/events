...
en: {
"준비 중": "Coming soon",
"서울 송파구 올림픽로 300 롯데월드타워 31층<span class=\"sub\">SKY31 CONFERENCE A룸</span>": "31F, Lotte World Tower, 300 Olympic-ro, Songpa-gu, Seoul<span class=\"sub\">SKY31 CONFERENCE, Room A</span>",
"이번 서밋은 초청 기업을 대상으로 진행됩니다. 참석을 희망하신다면 <a href=\"#attend\">초청 안내</a>의 문의처로 남겨주시면 안내해 드리겠습니다.": "This summit is held for invited companies. If you would like to attend, leave a note with the contact in <a href=\"#attend\">Invitation</a> and we will get back to you.",
"마지막 순서(15:00~15:20)에 현장에서 진행합니다. 응모하시려면 <a href=\"https://kr.linkedin.com/company/shoplive\" target=\"_blank\" rel=\"noopener\">Shoplive 링크드인</a> 팔로우가 필요하며, 당첨자는 현장에서 바로 안내해 드립니다. 자리를 비우신 경우 재추첨될 수 있습니다.": "It runs on site in the final slot (15:00~15:20). To enter, follow <a href=\"https://kr.linkedin.com/company/shoplive\" target=\"_blank\" rel=\"noopener\">Shoplive on LinkedIn</a>; winners are announced on the spot. If you are away from your seat, we may draw again.",
"헬스·웰니스": "Health &amp; Wellness",
"건강·웰니스 라이브, 관심을 구매로 바꾸는 방법": "Health &amp; wellness live — turning interest into purchase",
"<b>이주희</b> 풀리오 온라인세일즈 파트장 (라이브커머스 총괄)": "<b>Juhee Lee</b> Team Lead, Online Sales (Head of Live Commerce), Pulio",
"건강·웰니스 라이브, 관심을 구매로 바꾸는 방법<small>이주희 온라인세일즈 파트장 / 풀리오</small>": "Health &amp; wellness live — turning interest into purchase<small>Juhee Lee, Team Lead, Online Sales / Pulio</small>",
"이주희 온라인세일즈 파트장 / 풀리오": "Juhee Lee, Team Lead, Online Sales / Pulio",
"풀리오 라이브 사례를 통해 건강·웰니스 제품의 특성에 맞는 콘텐츠와 소통 전략, 고객의 관심을 구매로 전환하는 라이브커머스 운영 노하우를 소개합니다.": "Through Pulio's real live sessions, see the content and communication strategy suited to health and wellness products, and the operating know-how that turns customer interest into purchase.",
"금융": "Finance",
"어려운 금융, 라이브로 어떻게 고객과 소통하는가?": "Finance feels hard — how does a bank talk with its customers through live?",
"<b>하현승</b> 하나은행 디지털금융부 차장 (라이브커머스 총괄)": "<b>Hyunseung Ha</b> Deputy General Manager (Live Commerce Lead), Digital Finance Department, Hana Bank",
"어려운 금융, 라이브로 어떻게 고객과 소통하는가?<small>하현승 라이브커머스 총괄 / 하나은행</small>": "Finance feels hard — how does a bank talk with its customers through live?<small>Hyunseung Ha, Live Commerce Lead / Hana Bank</small>",
"하현승 라이브커머스 총괄 / 하나은행": "Hyunseung Ha, Live Commerce Lead / Hana Bank",
"금융 상품 소개부터 채용, 브랜드 커뮤니케이션까지 금융사는 라이브를 통해 고객과 어떻게 소통하는지 알아봅니다.": "From product introductions to recruiting and brand communication — see how a bank talks with its customers through live.",
"라이브 기술이 만드는 <span>확장과 기회</span>": "Video commerce that drives <span>growth and opportunity</span>",
"라이브커머스를 이끄는<br /><em>각 분야의 리더</em>들이 한 자리에": "<em>The leaders</em> of every corner of live commerce,<br />together in one room",
...
"무신사 라이브, 콘텐츠와 커머스의 경계를 넘어": "MUSINSA Live — crossing the line between content and commerce",
"리빙 라이브의 진화, 구경을 넘어 구매로": "Living goes further — from browsing to buying",
"매주 화/목요일 밤 8시, 4년째 같은 자리": "Every Tuesday and Thursday at 8 p.m., four years in the same slot",
"일본 Beauty Live Commerce의 특징과 인사이트": "Inside Japan's beauty live commerce — what makes it different",
"라이브를 바꾸는 제품 업데이트, 그리고 AI": "Product updates reshaping live, and AI",
"숫자로 본 라이브, 지난 1년간의 성과": "Live by the numbers — the past year in results",
"행사 총괄 · 사회 · 진행": "Event lead & host",
"데모부스": "Demo booth",
...
"<b>김모을</b> MUSINSA 커머스마케팅 본부장": "<b>Moeul Kim</b> Head of Commerce Marketing Division, MUSINSA",
...
"<b>오니시 기요타카</b> istyle Connect Experience 본부장": "<b>Kiyotaka Onishi</b> Head of Connect Experience Division, istyle",
...
"정보가 넘칠수록 소비자의 선택은 오히려 어려워집니다. @cosme는 라이브를 통해 소비자 한 명 한 명에게 맞춘 ‘개인화된 접객’을 구현하고, 댓글과 실시간 소통을 관계 형성의 기회로 연결해 구매를 이끌어내고 있습니다. 그 실전 노하우를 짚어봅니다.": "The more information shoppers have, the harder it gets to choose. @cosme uses live to serve each shopper personally, turning comments and real-time conversation into relationships that lead to a purchase. A close look at how they do it.",
...
"6년간 라이브커머스를 통해 성장해온 무신사가 그 과정에서 발견한 콘텐츠와 커머스의 새로운 가능성, 변화하는 고객 경험, 그리고 앞으로 만들어갈 성장의 방향을 이야기합니다.": "Having grown through six years of live commerce, MUSINSA shares the new possibilities it found at the intersection of content and commerce, how customer experience is changing, and the direction of growth it plans to build next.",
"D2C 브랜드는 라이브를 어떻게 고객과의 관계와 매출로 연결할까. 라이브 기획부터 콘텐츠 구성, 고객 소통과 운영까지 실제 성과를 만들어낸 방법을 사례와 함께 공유합니다.": "How do D2C brands turn live into customer relationships and revenue? From planning and content to customer communication and day-to-day operations, this session shares the methods that produced real results, with actual cases.",
"최근 릴리스한 기능부터 현재 준비 중인 기능까지, 샵라이브 제품 업데이트를 한자리에 정리합니다. 구축과 운영, 데이터까지 무엇이 달라졌는지 짚고, AI를 활용해 라이브 운영을 개선하는 기능도 함께 소개합니다.": "A single round-up of Shoplive product updates, from what shipped recently to what is still in the works. See what has changed across setup, operations and data, plus the AI features that make running a live show easier.",
...
"다음 프로젝트에 활용할 인사이트 얻기": "Take away insight you can use on your next project",
...
"매주 화/목요일 밤 8시, 4년째 같은 자리<small>이유빈 대표 / 마른파이브</small>": "Every Tuesday and Thursday at 8 p.m., four years in the same slot<small>Yubin Lee, CEO / Marn5</small>",
"소셜 미디어": "Social Media",
"메타가 비디오 커머스에 주목하는 이유": "Why Meta is betting on video commerce",
"<b>최영</b> Meta Korea 전무 (이커머스 총괄)": "<b>Young Choi</b> Managing Director (Head of eCommerce), Meta Korea",
"메타가 비디오 커머스에 주목하고 투자하는 이유를 짚어봅니다. 인스타그램을 중심으로 브랜드들이 어떤 기회를 만들어갈 수 있는지, 메타의 시각에서 이야기합니다.": "A look at why Meta is focusing on and investing in video commerce — and, from Meta's perspective, the opportunities brands can build around Instagram.",
"메타가 비디오 커머스에 주목하는 이유<small>최영 전무 / Meta Korea</small>": "Why Meta is betting on video commerce<small>Young Choi, Managing Director / Meta Korea</small>",
"매주 화/목요일 밤 8시, 4년째 같은 자리<small>김시영 대표 / R2W</small>": "Every Tuesday and Thursday at 8 p.m., four years in the same slot<small>Siyoung Kim, CEO / R2W</small>",
"<b>김시영</b> R2W 대표": "<b>Siyoung Kim</b> CEO, R2W",
...
"라이브를 바꾸는 제품 업데이트, 그리고 AI<small>이규원 / SHOPLIVE CTO</small>": "Product updates reshaping live, and AI<small>Kyuwon Lee / SHOPLIVE CTO</small>",
"일본 Beauty Live Commerce의 특징과 인사이트<small>오니시 기요타카 본부장 / istyle</small>": "Inside Japan's beauty live commerce — what makes it different<small>Kiyotaka Onishi, Head of Connect Experience Division / istyle</small>",
"쉬는 시간 · 데모부스": "Break &amp; demo booth",
"무신사 라이브, 콘텐츠와 커머스의 경계를 넘어<small>김모을 커머스마케팅 본부장 / MUSINSA</small>": "MUSINSA Live — crossing the line between content and commerce<small>Moeul Kim, Head of Commerce Marketing Division / MUSINSA</small>",
...
"김모을 커머스마케팅 본부장 / MUSINSA": "Moeul Kim, Head of Commerce Marketing Division / MUSINSA",
"오니시 기요타카 본부장 / istyle": "Kiyotaka Onishi, Head of Connect Experience Division / istyle",
...
ja: {
"준비 중": "準備中",
"서울 송파구 올림픽로 300 롯데월드타워 31층<span class=\"sub\">SKY31 CONFERENCE A룸</span>": "ソウル市松坡区オリンピック路300 ロッテワールドタワー31階<span class=\"sub\">SKY31 CONFERENCE Aルーム</span>",
"이번 서밋은 초청 기업을 대상으로 진행됩니다. 참석을 희망하신다면 <a href=\"#attend\">초청 안내</a>의 문의처로 남겨주시면 안내해 드리겠습니다.": "本サミットは招待企業を対象に開催します。ご参加をご希望の場合は、<a href=\"#attend\">招待のご案内</a>に記載の連絡先までお知らせいただければご案内いたします。",
"마지막 순서(15:00~15:20)에 현장에서 진행합니다. 응모하시려면 <a href=\"https://kr.linkedin.com/company/shoplive\" target=\"_blank\" rel=\"noopener\">Shoplive 링크드인</a> 팔로우가 필요하며, 당첨자는 현장에서 바로 안내해 드립니다. 자리를 비우신 경우 재추첨될 수 있습니다.": "最後のプログラム（15:00~15:20）に会場で実施します。ご応募には<a href=\"https://kr.linkedin.com/company/shoplive\" target=\"_blank\" rel=\"noopener\">Shoplive LinkedIn</a>のフォローが必要です。当選者は会場でその場でご案内します。席を外されている場合は再抽選となることがあります。",
"헬스·웰니스": "ヘルス・ウェルネス",
"건강·웰니스 라이브, 관심을 구매로 바꾸는 방법": "健康・ウェルネスライブ、関心を購買に変える方法",
"<b>이주희</b> 풀리오 온라인세일즈 파트장 (라이브커머스 총괄)": "<b>イ・ジュヒ</b> オンラインセールス パートリーダー（ライブコマース統括）、Pulio",
"건강·웰니스 라이브, 관심을 구매로 바꾸는 방법<small>이주희 온라인세일즈 파트장 / 풀리오</small>": "健康・ウェルネスライブ、関心を購買に変える方法<small>イ・ジュヒ オンラインセールス パートリーダー / Pulio</small>",
"이주희 온라인세일즈 파트장 / 풀리오": "イ・ジュヒ オンラインセールス パートリーダー / Pulio",
"풀리오 라이브 사례를 통해 건강·웰니스 제품의 특성에 맞는 콘텐츠와 소통 전략, 고객의 관심을 구매로 전환하는 라이브커머스 운영 노하우를 소개합니다.": "Pulioの実際のライブ事例を通じて、健康・ウェルネス製品の特性に合ったコンテンツとコミュニケーション戦略、顧客の関心を購買につなげるライブコマース運営ノウハウを紹介します。",
"금융": "金融",
"어려운 금융, 라이브로 어떻게 고객과 소통하는가?": "難しい金融、ライブで顧客とどうコミュニケーションするか？",
"<b>하현승</b> 하나은행 디지털금융부 차장 (라이브커머스 총괄)": "<b>ハ・ヒョンスン</b> デジタル金融部 次長（ライブコマース統括）、ハナ銀行",
"어려운 금융, 라이브로 어떻게 고객과 소통하는가?<small>하현승 라이브커머스 총괄 / 하나은행</small>": "難しい金融、ライブで顧客とどうコミュニケーションするか？<small>ハ・ヒョンスン ライブコマース統括 / ハナ銀行</small>",
"하현승 라이브커머스 총괄 / 하나은행": "ハ・ヒョンスン ライブコマース統括 / ハナ銀行",
"금융 상품 소개부터 채용, 브랜드 커뮤니케이션까지 금융사는 라이브를 통해 고객과 어떻게 소통하는지 알아봅니다.": "金融商品の紹介から採用、ブランドコミュニケーションまで、金融会社がライブを通じて顧客とどのようにコミュニケーションしているかを紹介します。",
"라이브 기술이 만드는 <span>확장과 기회</span>": "ライブ技術がひらく<span>拡張と成長の機会</span>",
"라이브커머스를 이끄는<br /><em>각 분야의 리더</em>들이 한 자리에": "ライブコマースを牽引する<br /><em>各分野のリーダー</em>が一堂に会する",
...
"찾아오시는 길": "アクセス",
"자주 묻는 질문": "よくあるご質問",
"무신사 라이브, 콘텐츠와 커머스의 경계를 넘어": "MUSINSAライブ、コンテンツとコマースの境界を越えて",
"리빙 라이브의 진화, 구경을 넘어 구매로": "リビングライブの進化 — 見るだけから買うへ",
"매주 화/목요일 밤 8시, 4년째 같은 자리": "毎週火・木曜の夜8時、4年間変わらない同じ場所",
"일본 Beauty Live Commerce의 특징과 인사이트": "日本のビューティライブコマース — その特徴とインサイト",
"라이브를 바꾸는 제품 업데이트, 그리고 AI": "ライブを変えるプロダクトアップデート、そしてAI",
"숫자로 본 라이브, 지난 1년간의 성과": "数字で見るライブ — この1年の成果",
"행사 총괄 · 사회 · 진행": "イベント統括・司会進行",
"데모부스": "デモブース",
"네트워킹 런치": "ネットワーキングランチ",
"기념품": "記念品",
"럭키드로우": "抽選会",
...
"<b>김모을</b> MUSINSA 커머스마케팅 본부장": "<b>キム・モウル</b> MUSINSA コマースマーケティング本部 本部長",
...
"<b>오니시 기요타카</b> istyle Connect Experience 본부장": "<b>大西清貴</b> istyle Connect Experience本部 本部長",
...
"D2C 브랜드는 라이브를 어떻게 고객과의 관계와 매출로 연결할까. 라이브 기획부터 콘텐츠 구성, 고객 소통과 운영까지 실제 성과를 만들어낸 방법을 사례와 함께 공유합니다.": "D2Cブランドはライブをどのように顧客との関係と売上につなげているのか。ライブの企画からコンテンツ構成、顧客コミュニケーションと運営まで、実際に成果を生んだ方法を事例とともに共有します。",
"정보가 넘칠수록 소비자의 선택은 오히려 어려워집니다. @cosme는 라이브를 통해 소비자 한 명 한 명에게 맞춘 ‘개인화된 접객’을 구현하고, 댓글과 실시간 소통을 관계 형성의 기회로 연결해 구매를 이끌어내고 있습니다. 그 실전 노하우를 짚어봅니다.": "情報があふれるほど、消費者は選びにくくなります。@cosmeはライブを通じて一人ひとりに合わせた「パーソナライズされた接客」を実現し、コメントやリアルタイムのやり取りを関係づくりの機会につなげて購買へと導いています。その実践ノウハウを紐解きます。",
...
"6년간 라이브커머스를 통해 성장해온 무신사가 그 과정에서 발견한 콘텐츠와 커머스의 새로운 가능성, 변화하는 고객 경험, 그리고 앞으로 만들어갈 성장의 방향을 이야기합니다.": "6年間ライブコマースを通じて成長してきたMUSINSAが、その過程で見出したコンテンツとコマースの新たな可能性、変化する顧客体験、そしてこれから描く成長の方向性について語ります。",
"최근 릴리스한 기능부터 현재 준비 중인 기능까지, 샵라이브 제품 업데이트를 한자리에 정리합니다. 구축과 운영, 데이터까지 무엇이 달라졌는지 짚고, AI를 활용해 라이브 운영을 개선하는 기능도 함께 소개합니다.": "直近リリースした機能から現在準備中の機能まで、Shopliveのプロダクトアップデートを一度に整理します。構築・運用・データまで何が変わったのかを押さえ、AIを活用してライブ運営を改善する機能もあわせて紹介します。",
...
"다음 프로젝트에 활용할 인사이트 얻기": "次のプロジェクトに活かせるインサイトを得る",
...
"매주 화/목요일 밤 8시, 4년째 같은 자리<small>이유빈 대표 / 마른파이브</small>": "毎週火・木曜の夜8時、4年間変わらない同じ場所<small>イ・ユビン代表 / Marn5</small>",
"소셜 미디어": "SNS",
"메타가 비디오 커머스에 주목하는 이유": "メタがビデオコマースに注目する理由",
"<b>최영</b> Meta Korea 전무 (이커머스 총괄)": "<b>チェ・ヨン</b> Meta Korea 専務（Eコマース統括）",
"메타가 비디오 커머스에 주목하고 투자하는 이유를 짚어봅니다. 인스타그램을 중심으로 브랜드들이 어떤 기회를 만들어갈 수 있는지, 메타의 시각에서 이야기합니다.": "メタがビデオコマースに注目し投資する理由を探ります。Instagramを中心に、ブランドがどのような機会をつくれるのか、メタの視点から語ります。",
"메타가 비디오 커머스에 주목하는 이유<small>최영 전무 / Meta Korea</small>": "メタがビデオコマースに注目する理由<small>チェ・ヨン 専務 / Meta Korea</small>",
"매주 화/목요일 밤 8시, 4년째 같은 자리<small>김시영 대표 / R2W</small>": "毎週火・木曜の夜8時、4年間変わらない同じ場所<small>キム・シヨン代表 / R2W</small>",
"<b>김시영</b> R2W 대표": "<b>キム・シヨン</b> R2W代表",
...
"라이브를 바꾸는 제품 업데이트, 그리고 AI<small>이규원 / SHOPLIVE CTO</small>": "ライブを変えるプロダクトアップデート、そしてAI<small>イ・ギュウォン / SHOPLIVE CTO</small>",
"일본 Beauty Live Commerce의 특징과 인사이트<small>오니시 기요타카 본부장 / istyle</small>": "日本のビューティライブコマース — その特徴とインサイト<small>大西清貴 Connect Experience本部長 / istyle</small>",
"쉬는 시간 · 데모부스": "休憩・デモブース",
"무신사 라이브, 콘텐츠와 커머스의 경계를 넘어<small>김모을 커머스마케팅 본부장 / MUSINSA</small>": "MUSINSAライブ、コンテンツとコマースの境界を越えて<small>キム・モウル コマースマーケティング本部長 / MUSINSA</small>",
...
"김모을 커머스마케팅 본부장 / MUSINSA": "キム・モウル コマースマーケティング本部長 / MUSINSA",
"오니시 기요타카 본부장 / istyle": "大西清貴 Connect Experience本部長 / istyle",
