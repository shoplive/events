...
"건강·웰니스 브랜드의 라이브, 관심을 구매로 바꾸는 방법": "Live for health &amp; wellness brands — turning interest into purchase",
"<b>이주희</b> 풀리오 파트장 (라이브커머스 총괄)": "<b>Juhee Lee</b> Team Lead (Head of Live Commerce), Pulio",
"건강·웰니스 브랜드의 라이브, 관심을 구매로 바꾸는 방법<small>이주희 파트장 / 풀리오</small>": "Live for health &amp; wellness brands — turning interest into purchase<small>Juhee Lee, Team Lead / Pulio</small>",
"이주희 파트장 / 풀리오": "Juhee Lee, Team Lead / Pulio",
"풀리오의 실제 라이브 사례를 통해 건강·웰니스 제품의 특성에 맞는 콘텐츠와 소통 전략, 고객의 관심을 구매로 전환하는 라이브커머스 운영 노하우를 소개합니다.": "Through Pulio's real live sessions, see the content and communication strategy suited to health and wellness products, and the operating know-how that turns customer interest into purchase.",
"금융": "Finance",
"금융 라이브로 어떻게 고객과 소통하는가?": "How does a bank talk with its customers through live?",
"<b>오주영</b> KEB하나은행 데이터마케팅팀 라이브커머스 총괄": "<b>Juyoung Oh</b> Head of Live Commerce, Data Marketing Team, KEB Hana Bank",
"금융 라이브로 어떻게 고객과 소통하는가?<small>오주영 총괄 / KEB하나은행</small>": "How does a bank talk with its customers through live?<small>Juyoung Oh, Head of Live Commerce / KEB Hana Bank</small>",
...
"<b>오니시 기요타카</b> @cosme Connect Experience본부 본부장": "<b>Kiyotaka Onishi</b> Head of Connect Experience Division, @cosme",
...
"팬이 고객으로 바꾸는 순간, 인플루언서 라이브의 운영 노하우<small>하준파파 대표 / 리바이포유</small>": "Turning fans into customers — how influencer live is run<small>Hajunpapa, CEO / Rbfy</small>",
"<b>하준파파</b> 리바이포유 대표": "<b>Hajunpapa</b> CEO, Rbfy",
...
ja: {
"헬스·웰니스": "ヘルス・ウェルネス",
"건강·웰니스 브랜드의 라이브, 관심을 구매로 바꾸는 방법": "健康・ウェルネスブランドのライブ、関心を購買に変える方法",
"<b>이주희</b> 풀리오 파트장 (라이브커머스 총괄)": "<b>イ・ジュヒ</b> パートリーダー（ライブコマース総括）、Pulio",
"건강·웰니스 브랜드의 라이브, 관심을 구매로 바꾸는 방법<small>이주희 파트장 / 풀리오</small>": "健康・ウェルネスブランドのライブ、関心を購買に変える方法<small>イ・ジュヒ パートリーダー / Pulio</small>",
"이주희 파트장 / 풀리오": "イ・ジュヒ パートリーダー / Pulio",
"풀리오의 실제 라이브 사례를 통해 건강·웰니스 제품의 특성에 맞는 콘텐츠와 소통 전략, 고객의 관심을 구매로 전환하는 라이브커머스 운영 노하우를 소개합니다.": "Pulioの実際のライブ事例を通じて、健康・ウェルネス製品の特性に合ったコンテンツとコミュニケーション戦略、顧客の関心を購買につなげるライブコマース運営ノウハウを紹介します。",
"금융": "金融",
"금융 라이브로 어떻게 고객과 소통하는가?": "金融ライブで顧客とどうコミュニケーションするか？",
"<b>오주영</b> KEB하나은행 데이터마케팅팀 라이브커머스 총괄": "<b>オ・ジュヨン</b> データマーケティングチーム ライブコマース総括、KEBハナ銀行",
"금융 라이브로 어떻게 고객과 소통하는가?<small>오주영 총괄 / KEB하나은행</small>": "金融ライブで顧客とどうコミュニケーションするか？<small>オ・ジュヨン 総括 / KEBハナ銀行</small>",
...
"<b>오니시 기요타카</b> @cosme Connect Experience본부 본부장": "<b>大西清貴</b> @cosme Connect Experience本部 本部長",
...
"팬이 고객으로 바꾸는 순간, 인플루언서 라이브의 운영 노하우<small>하준파파 대표 / 리바이포유</small>": "ファンを顧客に変える瞬間 — インフルエンサーライブの運営ノウハウ<small>ハジュンパパ代表 / Rbfy</small>",
"<b>하준파파</b> 리바이포유 대표": "<b>ハジュンパパ</b> Rbfy代表",
